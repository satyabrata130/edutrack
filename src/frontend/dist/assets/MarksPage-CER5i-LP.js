import { e as createLucideIcon, y as o, r as reactExports, z as vt, u as useStudents, b as useSubjects, c as useExams, A as useUpsertMark, D as useMarksForStudent, j as jsxRuntimeExports, l as Button, m as LoadingSpinner, F as FileText } from "./index-DPO0jM6g.js";
...
function cellKey(s, e) {
  return `${s}_${e}`;
}
function PassIndicator({ value }) {
  const num = Number(value);
  if (!value || Number.isNaN(num)) return null;
  const pass = num >= PASS_THRESHOLD;
  return pass ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 14, className: "text-primary shrink-0" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { size: 14, className: "text-destructive shrink-0" });
}
function MarkCell({
  value,
  onChange,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        ...
        placeholder: "—",
        "data-ocid": ocid,
        className: `w-16 h-8 rounded-md border px-2 text-sm font-mono text-right bg-background text-foreground transition-colors focus:outline-none focus:ring-2 focus:ring-ring ${isInvalid ? "border-destructive" : "border-input hover:border-primary/40"}`
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(PassIndicator, { value: isInvalid ? "" : value })
  ] });
}
function MarksPage() {
  ...
  const [draftMarks, setDraftMarks] = reactExports.useState({});
  const [savingAll, setSavingAll] = reactExports.useState(false);
  ...
  function setCell({ subjectId, examId }, value) {
    const k = cellKey(subjectId, examId);
    setDraftMarks((prev) => ({ ...prev, [k]: value }));
  }
  function getCell(subjectId, examId) {
    return draftMarks[cellKey(subjectId, examId)] ?? "";
  }
  function getExistingMark(subjectId, examId) {
    return existingMarks == null ? void 0 : existingMarks.find(
      (m) => m.subjectId.toString() === subjectId && m.examId.toString() === examId
    );
  }
  const dirtyCells = reactExports.useMemo(() => {
    const cells = [];
    for (const [k, v2] of Object.entries(draftMarks)) {
      if (!v2) continue;
      const num = Number(v2);
      if (Number.isNaN(num) || num < 0 || num > 100) continue;
      const [sid, eid] = k.split("_");
      const existing = existingMarks == null ? void 0 : existingMarks.find(
        (m) => m.subjectId.toString() === sid && m.examId.toString() === eid
      );
      if (!existing || existing.marksObtained.toString() !== v2) {
        cells.push({ subjectId: sid, examId: eid, value: v2 });
      }
    }
    return cells;
  }, [draftMarks, existingMarks]);
  const hasInvalid = reactExports.useMemo(() => {
    return Object.values(draftMarks).some((v2) => {
      if (!v2) return false;
      const num = Number(v2);
      return Number.isNaN(num) || num < 0 || num > 100;
    });
  }, [draftMarks]);
  async function saveSingleCell(subjectId, examId) {
    if (!studentId) return;
    const value = getCell(subjectId, examId);
    const num = Number(value);
    if (!value || Number.isNaN(num) || num < 0 || num > 100) {
      ue.error("Mark must be between 0 and 100");
      return;
    }
    ...
    await upsertMut.mutateAsync({
      ...
      remarks: (existing == null ? void 0 : existing.remarks) ?? ""
    });
    ue.success("Mark saved");
  }
  async function saveAll() {
    ...
    try {
      for (const cell of dirtyCells) {
        await upsertMut.mutateAsync({
          studentId,
          subjectId: BigInt(cell.subjectId),
          examId: BigInt(cell.examId),
          marksObtained: BigInt(Math.round(Number(cell.value))),
          remarks: ((_a = getExistingMark(cell.subjectId, cell.examId)) == null ? void 0 : _a.remarks) ?? ""
        });
      }
      ue.success(
      ...
      ue.error("Failed to save some marks");
    } finally {
      setSavingAll(false);
    }
  }
  const isDataLoading = studentsLoading || subjectsLoading || examsLoading;
  const selectedStudent = students == null ? void 0 : students.find(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 max-w-5xl", "data-ocid": "marks.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-display font-bold text-foreground", children: "Marks Entry" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Record or update student marks per subject and exam." })
    ] }),
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex h-6 w-6 items-center justify-center rounded-full bg-primary text-primary-foreground text-xs font-bold shrink-0", children: "1" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-foreground", children: "Select Student" })
          ] }),
          isDataLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-10 w-72" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-4 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-w-56 max-w-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Select,
              {
                label: "Student",
                id: "student-select",
            ...
            selectedStudent && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm text-muted-foreground pb-0.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 14 }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: selectedStudent.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "·" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: selectedStudent.rollNumber }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "·" }),
    ...
    studentId && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", "data-ocid": "marks.grid.section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex h-6 w-6 items-center justify-center rounded-full bg-primary text-primary-foreground text-xs font-bold shrink-0", children: "2" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-foreground", children: "Enter Marks" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            size: "sm",
            children: savingAll ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
      ...
      marksLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      ) : (subjects ?? []).length === 0 || (exams ?? []).length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "card-elevated rounded-lg flex flex-col items-center py-16 text-center",
          "data-ocid": "marks.empty_state",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { size: 32, className: "text-muted-foreground mb-3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground", children: "No subjects or exams configured" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Add subjects and exams in the admin panel first." })
          ]
        }
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border bg-muted/30", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "sticky left-0 z-10 bg-muted/30 text-left px-4 py-3 font-semibold text-foreground whitespace-nowrap", children: "Subject" }),
              (exams ?? []).map((exam) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "th",
                {
                  className: "px-3 py-3 text-center font-semibold text-foreground whitespace-nowrap min-w-28",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: exam.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground font-normal", children: [
                      "Max: ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-center font-semibold text-foreground whitespace-nowrap", children: "Actions" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: (subjects ?? []).map((subject, si) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "tr",
              {
                className: `border-b border-border last:border-0 ${si % 2 === 0 ? "" : "bg-muted/10"}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "sticky left-0 z-10 px-4 py-3 font-medium text-foreground bg-card whitespace-nowrap", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: subject.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: subject.code })
                  ] }),
                  (exams ?? []).map((exam, ei) => {
                    ...
                    const isInvalid = val !== "" && (Number.isNaN(num) || num < 0 || num > 100);
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3 py-3 text-center", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        MarkCell,
                        {
                          value: val,
                          onChange: (v2) => setCell({ subjectId: sid, examId: eid }, v2),
                          ocid: `marks.cell.${si + 1}.${ei + 1}`
                        }
                      ),
                      isInvalid && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive mt-0.5", children: "0–100" })
                    ] }, eid);
                  }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center gap-1 flex-wrap", children: (exams ?? []).map((exam) => {
                    const sid = subject.id.toString();
                    const eid = exam.id.toString();
                    const val = getCell(sid, eid);
                    const existing = getExistingMark(sid, eid);
                    const isDirty = val && (!existing || existing.marksObtained.toString() !== val);
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 text-xs text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 12, className: "text-primary" }),
          "Pass (≥",
          PASS_THRESHOLD,
          ")"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { size: 12, className: "text-destructive" }),
          "Fail (<",
          PASS_THRESHOLD,
          ")"
        ] }),
        dirtyCells.length > 0 && !hasInvalid && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "secondary", className: "ml-auto", children: [
          dirtyCells.length,
          " unsaved change",
          dirtyCells.length > 1 ? "s" : ""
        ] }),
        hasInvalid && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "destructive", className: "ml-auto", children: "Fix invalid entries before saving" })
      ] })
    ] })
  ] });
}
export {
  MarksPage as default
};
